...
namespace MyAudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        static AudioTrack c3po = new AudioTrack(new Uri("Audio/Kick in Rock.mp3", UriKind.Relative),"Kick in Rock","Barbuz","Barbuz the great hits",null);
        ...
        {
            player.Track = c3po; 
            if((player.Track != null)/* && (sharedLogic.isPlaying != 2)*/)
            {
                player.Play();
            }
